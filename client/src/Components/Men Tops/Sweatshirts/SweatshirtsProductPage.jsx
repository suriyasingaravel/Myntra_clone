...
export default function SweatShirtsProductPage() {
  ...
  const sweatshirtsData = products.filter((el) => {
    return el.category === "Sweatshirts"  && el.gender === "Men" ; 
  });


  console.log(sweatshirtsData);
